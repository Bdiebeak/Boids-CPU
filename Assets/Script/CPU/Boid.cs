...
namespace Bdiebeak.BoidsCPU
{
	public class Boid : MonoBehaviour
	{
		...
		private void OnDrawGizmosSelected()
		{
			...
			if (Physics.SphereCast(position, settings.boundsRadius, forward, out _, settings.collisionAvoidDst,
				    settings.obstacleMask))
			{
			...
			{
				if (Physics.SphereCast(position, settings.boundsRadius, direction, out _, settings.collisionAvoidDst,
					    settings.obstacleMask))
				{
